...
If writing fiction using flat files with full version control, help in navigating, and keeping your fiction facts straight then this might be for you.
...
It is assumed that if you know how to set all this up, you are also be able to figure out how Lozenge works.
