...
[
  ...
  {
    // Substitute placeholder with current workspaceFolder path
    "args": {
      "filesToInclude": ".asciidoctorconfig.adoc", // Limit scope for safety
      "find": "◊Press_alt_p_to_fix◊", // Placeholder that leads user to here
      "isRegex": true,
      "matchCase": true, // Limit scope for safety
      "preserveCase": false, // Keep replace value as-is
      "replace": "${workspaceFolder}", // Slashes come through escaped
      "triggerReplaceAll": true, // Will still present confirmation dialog
      "triggerSearch": true // Required to triggerReplacAll
    },
